...
// Sundar: #include "system/debug/sys_debug.h"
#include "drv_usbfs.h"
#include "drv_usbfs_variant_mapping.h"
// Sundar: #include "osal/osal.h"
// Sundar: #include "system/devcon/sys_devcon.h"
// Sundar: #include "peripheral/osc/plib_osc.h"
#include "usb_host.h"
...
typedef enum
{
    ...
    DRV_USBFS_TASK_STATE_INITIALIZE_OPERATION_MODE = 1,

    /* Driver has complete initialization and can be opened */
    DRV_USBFS_TASK_STATE_RUNNING

} DRV_USBFS_TASK_STATE;

typedef enum
{
    DRV_USBFS_DEVICE_EP0_STATE_EXPECTING_SETUP_FROM_HOST,
    DRV_USBFS_DEVICE_EP0_STATE_WAITING_FOR_SETUP_IRP_FROM_CLIENT,
	
    DRV_USBFS_DEVICE_EP0_STATE_EXPECTING_RX_DATA_STAGE_FROM_HOST,
	DRV_USBFS_DEVICE_EP0_STATE_WAITING_FOR_RX_DATA_IRP_FROM_CLIENT,
    DRV_USBFS_DEVICE_EP0_STATE_WAITING_FOR_RX_STATUS_IRP_FROM_CLIENT,
    DRV_USBFS_DEVICE_EP0_STATE_WAITING_FOR_RX_STATUS_COMPLETE,
	
    DRV_USBFS_DEVICE_EP0_STATE_WAITING_FOR_TX_DATA_IRP_FROM_CLIENT,
    DRV_USBFS_DEVICE_EP0_STATE_WAITING_FOR_TX_STATUS_IRP_FROM_CLIENT,
	DRV_USBFS_DEVICE_EP0_STATE_WAITING_FOR_TX_STATUS_COMPLETE,
	DRV_USBFS_DEVICE_EP0_STATE_TX_DATA_STAGE_IN_PROGRESS
}
DRV_USBFS_DEVICE_EP0_STATE;
...
{	
    ...
    DRV_USBFS_DEVICE_EP0_STATE endpoint0State;
...
//    DRV_USBFS_DEVICE_ENDPOINT_OBJ * endpointTable;
    ...
    DRV_USBFS_DEVICE_ENDPOINT_OBJ * deviceEndpointObj[DRV_USBFS_ENDPOINTS_NUMBER];

    /* Pointer to the endpoint table */
    UsbDeviceDescriptor * endpointDescriptorTable;

    /* Pointer to the endpoint Buffers */
    uint8_t * endpointBufferPtr[DRV_USBFS_ENDPOINTS_NUMBER][USB_DEVICE_EP0_NUMBER_OF_BANKS];
