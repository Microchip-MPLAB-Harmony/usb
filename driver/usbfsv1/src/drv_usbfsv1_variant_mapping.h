...
// Sundar:         #include "driver/usb/usbfs/drv_usbfs_static.h"
...
// Sundar: 
    ...
    #define _DRV_USBFS_InterruptSourceEnable(source)      false
    #define _DRV_USBFS_InterruptSourceDisable(source)     false
    #define _DRV_USBFS_InterruptSourceClear(source)       false
