...
/**************************************************
 * USB Device Function Driver Inits Data
 **************************************************/
 ...
 * structure.
 ***********************************************/
uint8_t flashRowBackupBuffer [EFC0_PAGESIZE];
...
const uint8_t highSpeedConfigurationDescriptor[]=
{
    ...
    USB_DEVICE_16bitTo8bitArrange(98),                  //(98 Bytes)Size of the Config descriptor
    ...
    USB_DESCRIPTOR_ENDPOINT,        // Endpoint Descriptor
    3 | USB_EP_DIRECTION_IN,    // EndpointAddress ( EP1 IN INTERRUPT)
    ...
    0x07,                       // Size of this descriptor
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    4 | USB_EP_DIRECTION_OUT,   // EndpointAddress ( EP2 OUT )
    USB_TRANSFER_TYPE_BULK,     // Attributes type of EP (BULK)
    0x00, 0x02,                 // Max packet size of this EP
    0x00,                       // Interval (in ms)
    ...
    0x07,                       // Size of this descriptor
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    5 | USB_EP_DIRECTION_IN,    // EndpointAddress ( EP3 IN )
