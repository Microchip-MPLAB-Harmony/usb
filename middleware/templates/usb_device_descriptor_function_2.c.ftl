...
<#if CONFIG_USB_DEVICE_FUNCTION_2_DEVICE_CLASS_CDC_IDX0 == true>
    ...
    ${CONFIG_USB_DEVICE_FUNCTION_2_CDC_BULK_ENDPOINT_OUT_NUMBER_IDX0}|USB_EP_DIRECTION_OUT,     // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_2_CDC_BULK_ENDPOINT_OUT_NUMBER_IDX0} OUT)
    <#else>
    ...
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    <#if CONFIG_DSTBDPIC32CZ == true>
    ${CONFIG_USB_DEVICE_FUNCTION_2_CDC_BULK_ENDPOINT_IN_NUMBER_IDX0}|USB_EP_DIRECTION_IN,      // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_2_CDC_BULK_ENDPOINT_IN_NUMBER_IDX0} IN )
    <#else>
